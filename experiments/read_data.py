...
def generate_data():
    ...
    # short version
    # funcs = [read_ionosphere,read_breast_cancer,read_crabs,read_pima,read_sonar,read_glass,read_wine]
    # id_pairs = [(1,2),(2,3),(1,3)]
    # for r in range(9):
    #     if r<6:
    #         data = funcs[r]()
    #     else:
    #         data = funcs[6](id_pairs[r-6][0],id_pairs[r-6][1])
    #     for i in range(100):
    #         seed = i * 10
    #         split_data(data,'{}_{}'.format(datanames[r],i),seed,True)
    ...
    for i in range(100):
        ...
        split_data(read_glass(), 'glass_{}'.format(i), seed, True)
